<?php
	...
	/** 2. SORTI DES DONNEES **/
		...
		//$moteur->set_template_file('Templates/dev-custom-instruction-tag.tpl.html');

		//$moteur->set_template_file('Templates/dev-validation-tpl.html'); require_once "data-validation.php";
		//$moteur->set_template_file('Templates/dev-validation-2-tpl.html'); require_once "data-validation2.php";
		$moteur->set_template_file('Templates/dev-validation-3-tpl.html'); require_once "data-validation.php";
		...
		$moteur->set_template_tags('//-');
		//$moteur->set_var("BLK", Array(Array("ID" => 1, "NAME" => "Nicolas"), Array("ID" => 2, "NAME" => "Julien")));
